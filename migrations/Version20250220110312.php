 ...
 */
final class Version20250220110312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, company_name VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, number VARCHAR(255) NOT NULL, notes VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C7440455A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE client_category (client_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_28AA290419EB6921 (client_id), INDEX IDX_28AA290412469DE2 (category_id), PRIMARY KEY(client_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE job_offer_type (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, active TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, salary VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', lieu VARCHAR(255) DEFAULT NULL, position VARCHAR(255) DEFAULT NULL, contract_type VARCHAR(255) DEFAULT NULL, starting_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_1851E923989D9B62 (slug), INDEX IDX_1851E92319EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE client_category ADD CONSTRAINT FK_28AA290419EB6921 FOREIGN KEY (client_id) REFERENCES client (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE client_category ADD CONSTRAINT FK_28AA290412469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client_category DROP FOREIGN KEY FK_28AA290419EB6921');
        $this->addSql('ALTER TABLE client_category DROP FOREIGN KEY FK_28AA290412469DE2');
